...
class TrainOpts(BaseOpts):
    ...
    def initialize(self):
        ...
        #### Training Arguments ####
        self.parser.add_argument('--model',       default='NormAttentionPSN')
        ...
        self.parser.add_argument('--batch',       default=24,   type=int)
        self.parser.add_argument('--val_batch',   default=24,    type=int)

        #### Display Arguments ####
        self.parser.add_argument('--train_disp',  default=800,   type=int)
        self.parser.add_argument('--train_save',  default=800,  type=int)
